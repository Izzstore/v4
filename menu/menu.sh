...
export sem=$( curl -s https://raw.githubusercontent.com/IlhamStore23/permission/main/versions)
...
6969) clear ; wget https://raw.githubusercontent.com/IlhamStore23/v4/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
