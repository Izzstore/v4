#!/bin/bash
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Izzstore/permission/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Izzstore/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Izzstore/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/Izzstore/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/Izzstore/permission/main/versions)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
clear
echo -e "                         ${BIWhite}${UWhite}About${NC}"
echo -e "                 ${BICyan}Base Script : ${BIPurple}IlhamStore${NC}"
echo -e "                 ${BICyan}Bot Dev     : ${BIPurple}@JIHYOO${NC}"
...
echo -e " ${BICyan}         │  Expiry script${NC} : ${BIYellow}$Exp $exp $exp2 ${NC} Days"
echo -e " ${BICyan}         └─────────────────────────────────────┘${NC}"
echo
...
6969) clear ; wget https://raw.githubusercontent.com/Izzstore/v4/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
